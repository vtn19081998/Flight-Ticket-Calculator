...
class TicketCalculator(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle("Flight Ticket Calculator v5.1.1 | Tác giả: Batman")
        ...
        # Khởi tạo phím tắt với kiểm tra modal dialog
        self.shortcut_f5 = QShortcut(QKeySequence("F5"), self)
        self.shortcut_f5.activated.connect(self.edit_price)
