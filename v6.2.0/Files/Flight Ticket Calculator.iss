...
#define MyAppExeName "Flight Ticket Calculator v6.2.0.exe"
...
SetupIconFile=C:\Users\Batman\Documents\GitHub\Flight-Ticket-Calculator\v6.2.0\Python\images\icon.ico
...
[Files]
Source: "C:\Users\Batman\Documents\GitHub\Flight-Ticket-Calculator\v6.2.0\Files\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\Batman\Documents\GitHub\Flight-Ticket-Calculator\v6.2.0\Python\images\*"; DestDir: "{app}\images"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\Users\Batman\Documents\GitHub\Flight-Ticket-Calculator\v6.2.0\Python\data\*"; DestDir: "{app}\data"; Flags: ignoreversion recursesubdirs createallsubdirs
...
begin
  ...
  ProcessList := [
    ...
    'Flight Ticket Calculator v6.1.9.exe'
  ];
