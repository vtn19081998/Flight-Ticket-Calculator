...
#define MyAppVersion "6.1.8"
#define MyAppPublisher "Batman"
#define MyAppURL "http://phongvemaybay365.com/"
#define MyAppExeName "Flight Ticket Calculator v6.1.8.exe"
...
SetupIconFile=C:\Users\Batman\Documents\GitHub\Flight-Ticket-Calculator\v6.1.8\Python\images\icon.ico
...
[Files]
Source: "C:\Users\Batman\Documents\GitHub\Flight-Ticket-Calculator\v6.1.8\Files\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\Batman\Documents\GitHub\Flight-Ticket-Calculator\v6.1.8\Python\images\*"; DestDir: "{app}\images"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\Users\Batman\Documents\GitHub\Flight-Ticket-Calculator\v6.1.8\Python\data\*"; DestDir: "{app}\data"; Flags: ignoreversion recursesubdirs createallsubdirs
...
begin
  ...
  ProcessList := [
    AppExeName, // v6.1.8
    'Flight Ticket Calculator v6.1.5.exe',
