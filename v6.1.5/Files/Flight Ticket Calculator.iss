...
#define MyAppExeName "Flight Ticket Calculator v6.1.5.exe"
...
SetupIconFile=C:\Users\Batman\Documents\GitHub\Flight-Ticket-Calculator\v6.1.5\Python\images\icon.ico
...
[Files]
Source: "C:\Users\Batman\Documents\GitHub\Flight-Ticket-Calculator\v6.1.5\Files\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\Batman\Documents\GitHub\Flight-Ticket-Calculator\v6.1.5\Python\images\*"; DestDir: "{app}\images"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\Users\Batman\Documents\GitHub\Flight-Ticket-Calculator\v6.1.5\Python\data\*"; DestDir: "{app}\data"; Flags: ignoreversion recursesubdirs createallsubdirs
...
begin
  ...
  ProcessList := [
    AppExeName, // v6.1.5
    'Flight Ticket Calculator v6.1.1.exe',
    'Flight Ticket Calculator v6.1.2.exe',
    'Flight Ticket Calculator v6.1.3.exe',
    'Flight Ticket Calculator v6.1.4.exe'
  ];
