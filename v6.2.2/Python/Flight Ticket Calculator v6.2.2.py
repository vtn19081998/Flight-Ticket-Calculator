...
class TicketCalculator(QWidget):
    ...
    def load_logo_from_history(self, entry):
        ...
        # Try to match airline by flight number first
        ...
        # Fallback to detected airlines if no match by flight number
        ...
        if self.is_round_trip and not airline2 and len(detected_airlines) > 1:
            ...
            airline2 = detected_airlines[0]  # Use first airline if only one detected
