...
#define MyAppExeName "Flight Ticket Calculator v6.1.0.exe"
...
SetupIconFile=C:\Users\Batman\Documents\GitHub\Flight-Ticket-Calculator\v6.1.0\Python\images\icon.ico
...
[Files]
Source: "C:\Users\Batman\Documents\GitHub\Flight-Ticket-Calculator\v6.1.0\Files\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\Batman\Documents\GitHub\Flight-Ticket-Calculator\v6.1.0\Python\images\*"; DestDir: "{app}\images"; Flags: ignoreversion recursesubdirs createallsubdirs
...
begin
  ...
  begin
    ...
    begin
      if MsgBox('Không thể đóng ứng dụng {#MyAppName} hoặc các phiên bản cũ (v2.0.0, v3.0.1, v4.1.2, ...). Vui lòng kiểm tra Task Manager và đóng thủ công, sau đó thử lại, hoặc hủy để thoát.', mbError, MB_RETRYCANCEL) = IDCANCEL then
      begin
        Result := False;
        Retry := False;
      end;
