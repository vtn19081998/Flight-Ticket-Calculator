...
class TicketCalculator(QWidget):
    ...
    def check_running_instances(self):
        ...
        for proc in psutil.process_iter(['pid', 'exe', 'name', 'cmdline']):
            try:
                ...
                if (proc_exe == current_exe or
                    ...
                    # Kiểm tra tiêu đề cửa sổ từ cache
        ...
        msg = (
            ...
            f"{proc_info_str}\n\n"
            f"Bạn có muốn đóng các phiên bản này để tiếp tục không?"
        )
    ...
    def initUI(self):
        self.setWindowTitle("Flight Ticket Calculator v5.1.0 | Tác giả: Batman")
